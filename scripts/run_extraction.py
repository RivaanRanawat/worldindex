...
def main() -> None:
    ...
    last_clip_index = run_extraction(cpu_config)
    print({"last_clip_index": last_clip_index, "output_dir": str(cpu_config.output_dir)})
